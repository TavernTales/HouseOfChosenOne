...
public class ChatManager {
    ...
    public static void onPlayerReceiveMessages(AsyncPlayerChatEvent event) {
        ...
        while (iterator.hasNext()) {
            ...
            boolean localLimit = chatLocalIsLimitOutOfBoundsOrWorld(recipient, sender);

            if (playerHasOpOrPermission(recipient) && localLimit) {
    ...
    public static boolean chatLocalIsLimitOutOfBoundsOrWorld(Player player, Player sender) {
